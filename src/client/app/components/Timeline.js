...
const Timeline = () => (
  <div className="row timeline">
    <div className="col-xs-12">
      ...
      <blockquote>
        <i className="fa fa-quote-left"/>
        Supposing, for instance, that the fundamental relations of pitched sounds in the science of harmony and of musical composition were susceptible of such expression and adaptations, the engine might compose elaborate
